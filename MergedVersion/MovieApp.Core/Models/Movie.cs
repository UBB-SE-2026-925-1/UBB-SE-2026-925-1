...
public sealed class Movie
{
    ...
    /// <summary>
    /// Gets or sets the collection of reviews for this movie.
    /// </summary>
    public ICollection<Review> Reviews { get; set; } = new List<Review>();

    /// <summary>
    /// Gets or sets the collection of comments for this movie.
    /// </summary>
    ...
    /// <summary>
    /// Gets a display-friendly string of all genres associated with this movie.
    /// </summary>
    public string GenreDisplay => (Genres != null && Genres.Any()) 
