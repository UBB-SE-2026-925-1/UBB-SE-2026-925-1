...
public sealed class CurrentUserServiceTests
{
    ...
    private sealed class StubUserRepository(User? returnedUser) : IUserRepository
    {
        ...
        // CRUD stubs required by merged IUserRepository interface
        public Task<List<User>> GetAllAsync(CancellationToken ct = default) => throw new NotImplementedException();
        public Task<User?> GetByIdAsync(int id, CancellationToken ct = default) => throw new NotImplementedException();
        public Task<int> InsertAsync(User user, CancellationToken ct = default) => throw new NotImplementedException();
        public Task<bool> UpdateAsync(User user, CancellationToken ct = default) => throw new NotImplementedException();
